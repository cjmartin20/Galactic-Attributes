...
function five.createFive( x, y, scaler, currentAttribute )
	...
	afive:setFillColor( Red, Green, Blue )      -- fill the five with color
    --afive.strokeWidth = 0.016 * display.contentWidth   -- Sets the width of the border of five
	--Set Stroke color
    afive:setStrokeColor( 128, 0, 128 )    -- Sets the border color
    afive:addEventListener( "touch", five.move )
    afive.alpha = 0.7 --five opacity 
